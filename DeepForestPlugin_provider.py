...
from .DeepForestPlugin_algorithm import DeepForestPluginAlgorithm


class DeepForestPluginProvider(QgsProcessingProvider):
    ...
    def loadAlgorithms(self):
        ...
        """
        self.addAlgorithm(DeepForestPluginAlgorithm())
